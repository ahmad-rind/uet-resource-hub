...
export default function ResourceCard({ resource, onPreview }: ResourceCardProps) {
  ...
  return (
    <div
      ...
      className="relative rounded-[32px] overflow-hidden transition-transform duration-200 ease-[cubic-bezier(0.22,0.61,0.36,1)] hover:-translate-y-1 group flex flex-row h-[120px] md:h-[130px] cursor-pointer"
    ...
    >
      ...
      {/* Hover Arrow Overlay */}
      <div className="absolute top-5 right-5 opacity-0 group-hover:opacity-100 transition-[opacity,transform] duration-200 ease-out translate-x-1 group-hover:translate-x-0">
